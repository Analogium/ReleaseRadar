...
export default function Register() {
  ...
  return (
    <>
      <Seo
        title="Créer un compte · Release Radar"
        description="Créez votre compte Release Radar et suivez vos artistes préférés pour ne manquer aucune nouvelle sortie."
        path="/register"
      />
      <AuthLayout
